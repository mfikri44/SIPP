...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="p-10">
                    <form method="POST" class="user" action="{{ url('surat-keterangan/edit/' . $data->first()->id_keterangan) }}" enctype="multipart/form-data">
                        @csrf
<!-- FORM PEMOHON-->
<!-- FORM PEMOHON-->
<!-- FORM PEMOHON-->
...
<!-- FORM PEMOHON-->
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control"
                                name="nama_pemohon" placeholder="Nama Lengkap" value="{{ $data->first()->nama_pemohon }}">
                        </div>
                        <div class="form-group">
                            <label for="">Jenis Kelamin</label>
                            <select name="jenis_kelamin_pemohon" class="select form-control form-control-md">
                                <option value="{{ $data->first()->jenis_kelamin_pemohon }}" >{{ $data->first()->jenis_kelamin_pemohon }}</option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control"
                                name="tempat_lahir_pemohon" value="{{ $data->first()->tempat_lahir_pemohon }}">
                        </div>
                        <div class="form-group">
                            <label for="">Tanggal Lahir</label>
                            <input type="date" class="form-control"
                                name="tanggal_lahir_pemohon" value="{{ $data->first()->tanggal_lahir_pemohon }}">
                        </div>

                        <div class="form-group">
                            <label for="">Agama</label>
                            <select name="agama_pemohon" class="select form-control form-control-md">
                                <option value="{{ $data->first()->agama_pemohon }}" >{{ $data->first()->agama_pemohon }}</option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control"
                                name="berlaku_mulai" value="{{ $data->first()->berlaku_mulai }}">
                        </div>
                        <div class="form-group">
                            <label for="">Berlaku Sampai</label>
                            <input type="date" class="form-control"
                                name="berlaku_sampai" value="{{ $data->first()->berlaku_sampai }}">
                        </div>

                        <div class="form-group">
                            <label for="">Keperluan</label>
                            <input type="text" class="form-control"
                                name="keperluan" value="{{ $data->first()->keperluan }}">
                        </div>

                        <div class="form-group">
                            <label for="">Keteragan Lain</label>
                            <input type="text" class="form-control"
                                name="keterangan_lain" value="{{ $data->first()->keterangan_lain }}">
                        </div>
                        ...
                        <input type="hidden" readonly class="form-control" name="pemohon_id" value="{{ $data->first()->pemohon_id }}">
                        ...
                        <a href="{{ ('../surat-keterangan/' . Auth::user()->id ) }}" class="btn btn-secondary btn-user btn-block">
                            Kembali
                        </a>
